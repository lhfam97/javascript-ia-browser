...
export class ChatbotView {
  ...
  #renderBotDownloadMessageHTML() {
    return `
        ...
        <div class="ewcb-message-content">
            <p>
                Clique no botão ao lado para ativar o chatbot
                <button class="ewcb-btn-activate">
                   Baixar modelo
                </button>
            </p>
  ...
  appendDownloadMessage() {
    const el = this.#createBotMessage();
    el.innerHTML = this.#renderBotDownloadMessageHTML();
    this.#append(el);
  }
